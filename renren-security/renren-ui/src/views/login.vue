            ...
            <el-form-item label-width="0" prop="captcha">
              <el-space class="rr-login-right-main-code">
                ...
                <div style="width: 150px; flex-shrink: 0;">
                  <img style="height: 40px; width: 100%; cursor: pointer; border-radius: 4px; border: 1px solid #dcdfe6; display: block;" :src="state.captchaUrl" @click="onRefreshCode" alt="" title="看不清？点击刷新" />
                </div>
              </el-space>
            </el-form-item>
