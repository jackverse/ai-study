...
public class LoginController {
    ...
    @Operation(summary = "简化登录(仅用于测试)")
    public Result simpleLogin(HttpServletRequest request, @RequestBody LoginDTO login) {
        //效验数据
        AssertUtils.isBlank(login.getUsername(), "用户名不能为空");
        AssertUtils.isBlank(login.getPassword(), "密码不能为空");
